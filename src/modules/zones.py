...
class ZonesModule(BaseModule):
    ...
    def get_zone_details_by_id(
        ...
        Returns metadata including subnets, protocols, vendors, asset counts, risk score, 
        ...
        try:
            ...
            # Direct mapping assuming reliable integer returns from CTD
            ...
            # Construct clean dictionary using inline formatting to avoid nested functions
            details = {
